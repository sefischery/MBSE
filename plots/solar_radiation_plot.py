...
plt.plot(day_to_solar_rad_plot(januar), color='r')
plt.plot(day_to_solar_rad_plot(april), color='b')
plt.plot(day_to_solar_rad_plot(july), color='g')
plt.plot(day_to_solar_rad_plot(october), color='y')
plt.xlabel("Time of day [hour]")
plt.ylabel("Solar radiation [Watt/sqm]")
